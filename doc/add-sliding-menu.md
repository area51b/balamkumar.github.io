...
Create [MenuViewController](iOSApp/iOSApp/MenuViewController.h) Definition
...
@interface MenuSegue : UIStoryboardSegue

@end
```

Create [MenuViewController](iOSApp/iOSApp/MenuViewController.m) Implmentation
...
Update Main Storyboard as shown below
